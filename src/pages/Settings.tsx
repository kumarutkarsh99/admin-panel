      ...
      <div className="space-y-6">
        ...
        <Tabs defaultValue="profile" className="space-y-6">
            ...
            <Card className="border-0 shadow-sm bg-white/60 backdrop-blur-sm">
              ...
              <CardContent className="space-y-6">
                <div className="flex items-center gap-6">
                  ...
                  <div>
                    <Button variant="outline" className="bg-white/80">Upload Photo</Button>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  <div className="space-y-2">
                    ...
                    <Input id="firstName" placeholder="John" className="bg-white/80" />
                  </div>
                  <div className="space-y-2">
                    <Label htmlFor="lastName">Last Name</Label>
                    <Input id="lastName" placeholder="Doe" className="bg-white/80" />
                  </div>
                  <div className="space-y-2">
                    <Label htmlFor="email">Email</Label>
                    <Input id="email" type="email" placeholder="john.doe@company.com" className="bg-white/80" />
                  </div>
                  <div className="space-y-2">
                    <Label htmlFor="phone">Phone</Label>
                    <Input id="phone" placeholder="+1 (555) 123-4567" className="bg-white/80" />
                  </div>
                  <div className="space-y-2">
                    <Label htmlFor="title">Job Title</Label>
                    <Input id="title" placeholder="HR Manager" className="bg-white/80" />
                  </div>
                  <div className="space-y-2">
          ...
          <TabsContent value="company">
            <Card className="border-0 shadow-sm bg-white/60 backdrop-blur-sm">
              <CardHeader>
                <CardTitle className="text-slate-800">Company Settings</CardTitle>
              </CardHeader>
              <CardContent className="space-y-6">
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  <div className="space-y-2">
                    <Label htmlFor="companyName">Company Name</Label>
                    <Input id="companyName" placeholder="TalentFlow Inc." className="bg-white/80" />
                  </div>
                  <div className="space-y-2">
                    <Label htmlFor="website">Website</Label>
                    <Input id="website" placeholder="https://talentflow.com" className="bg-white/80" />
                  </div>
                  <div className="space-y-2">
                ...
                <div className="space-y-4">
                  <div className="flex items-center justify-between">
                    <div>
                      ...
                      <p className="text-sm text-slate-600">Get notified when new applications are received</p>
                    </div>
                  ...
                  <div className="flex items-center justify-between">
                    <div>
                      ...
                      <p className="text-sm text-slate-600">Get notified when candidates update their status</p>
                    </div>
                  ...
                  <div className="flex items-center justify-between">
                    <div>
                      ...
                      <p className="text-sm text-slate-600">Receive weekly recruitment analytics reports</p>
                    </div>
          ...
          <TabsContent value="email">
            <Card className="border-0 shadow-sm bg-white/60 backdrop-blur-sm">
              <CardHeader>
                <CardTitle className="text-slate-800">Email Templates</CardTitle>
              </CardHeader>
              <CardContent className="space-y-6">
                <div className="space-y-4">
                  <div className="space-y-2">
                    <Label htmlFor="applicationReceived">Application Received</Label>
                    <Textarea 
                  ...
                  <div className="space-y-2">
                    <Label htmlFor="interviewInvite">Interview Invitation</Label>
                    <Textarea 
                      id="interviewInvite" 
